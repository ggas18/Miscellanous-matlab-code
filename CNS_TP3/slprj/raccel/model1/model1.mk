...
MAKECMD         = /media/arek/DATA/Linux/matlab/bin/glnxa64/gmake
HOST            = UNIX
BUILD           = yes
...
MODEL                  = model1
MODULES                = model1_capi.c model1_data.c model1_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE               = model1.mk
MATLAB_ROOT            = /media/arek/DATA/Linux/matlab
ALT_MATLAB_ROOT        = /media/arek/DATA/Linux/matlab
MATLAB_ROOTQ           = \"/media/arek/DATA/Linux/matlab\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /media/arek/DATA/Windows10/Documents/MATLAB/CNS_TP3
...
COMPUTER               = GLNXA64
BUILDARGS              =  ISPROTECTINGMODEL=NOTPROTECTING RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/media/arek/DATA/Linux/matlab" EXT_MODE=1 OPTS="-DSLMSG_ALLOW_SYSTEM_ALLOC -DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/model1 \
